// Unit Circle Values
const values = ["0", "π/6", "π/4", "π/3", "2π/3", "3π/4", "5π/6", "π", "7π/6", "5π/4", "4π/3", "π/2", "5π/3", "7π/4", "11π/6", "2π"];

// Sine Values
const sines = ["0", "1/2", "√2/2", "√3/2", "√3/2", "√2/2", "1/2", "0", "-1/2", "-√2/2", "-√3/2", "-1", "-√3/2", "-√2/2", "-1/2", "0"];

// Cosine Values
const cosines = ["1", "√3/2", "√2/2", "1/2", "-1/2", "-√2/2", "-√3/2", "-1", "-√3/2", "-√2/2", "-1/2", "0", "1/2", "√2/2", "√3/2", "1"];

// Tangent Values
const tangents = ["0", "√3/3", "1", "√3", "-√3", "-1", "-√3/3", "0", "√3/3", "1", "√3", "und", "-√3", "-1", "-√3/3", "0"];
...
// Easy Problem Generator Function
var whichTrig = Math.floor(Math.random() * 6 + 1);
...
function createPblmUnitCircle() {
  if (whichTrig === 1)
    ...
    document.getElementById("question").innerHTML = "csc(" + values[whichVal] + ")";
  else if (whichTrig === 5)
    document.getElementById("question").innerHTML = "sec(" + values[whichVal] + ")";
  else if (whichTrig === 6)
    document.getElementById("question").innerHTML = "cot(" + values[whichVal] + ")";
}

// Hard Problem Generator Function
...
function getDataHardTest() {
  ...
  if (correctVal == checkVal) {
    localStorage.setItem("faultless", ++faultless);
    ...
    localStorage.setItem("faulty", ++faulty);
...
function getDataUnitCircle() {
  ...
  if (whichTrig === 1)
    ...
    accAns = cosecants[whichVal];
  else if (whichTrig === 5)
    accAns = secants[whichVal];
  else if (whichTrig === 6)
    accAns = cotangents[whichVal];
